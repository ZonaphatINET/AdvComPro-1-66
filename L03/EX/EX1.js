...
for (let i = 0; i < arr1.length; i++) { //i เป็นตัวชี้ดัชนี (index) ที่เริ่มต้นจาก 0 และเพิ่มขึ้นทีละหนึ่งในแต่ละรอบของลูปจนกว่าค่าของ i จะไม่น้อยกว่าความยาวของอาเรย์ arr1 (นั่นคือ จำนวนสมาชิกในอาเรย์ arr1)
