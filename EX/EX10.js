function isValidIP(str) {
  ...
  //คือการใช้ filter เพื่อกรองสมาชิกในอาร์เรย์ที่ได้จากการแบ่งส่วนด้านบน โดยตรวจสอบว่า:v==Number(v).toString() ค่าในส่วนนั้นต้องเป็นตัวเลขที่เหมือนกันเมื่อแปลงเป็นตัวเลขแล้วกลับมาเป็นสตริง 
